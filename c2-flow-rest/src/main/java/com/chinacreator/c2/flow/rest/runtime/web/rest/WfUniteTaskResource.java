...
public class WfUniteTaskResource {
	...
	public WfPageListResponse<WfUniteTaskResponse> getUniteTasks(
		...
		try{
			...
			if(null!=createTimeBefore) parameters.put("createtimeb",createTimeAfter);
			if(null!=createTimeAfter) parameters.put("createtimee",createTimeBefore);
			...
			WfUniteTaskResult wfUniteTaskResult= wfRuntimeService.queryWfUniteRunTask(parameters, start.intValue(), size.intValue());
