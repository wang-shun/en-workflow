...
public class HistoricTaskInstanceBaseResource {
  ...
  protected WfPageListResponse<WfHistoricTaskInstanceResponse> getQueryResponse(HistoricTaskInstanceQuery query,WfHistoricTaskInstanceQueryRequest queryRequest) {
  ...
  protected void addProcessVariables(HistoricTaskInstanceQuery taskInstanceQuery, List<WfQueryVariable> variables) {
	  C2RestResponseFactory responseFactory = new C2RestResponseFactory();
