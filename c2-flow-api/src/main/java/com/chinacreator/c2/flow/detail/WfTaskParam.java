 ...
 *
 */
public class WfTaskParam extends WfPageParam {
	...
	/**
	 * 只返回指定代理状态的任务。可选值为pending 和 resolved。
	 */
	...
	/**
	 * 根据任务期限排序，需要结合order一起使用
	 */
	Boolean orderByDueDate = false;
	/**
	 * 根据分支id排序，需要结合order一起使用
	 */
	Boolean orderByExecutionId = false;
	/**
	 * 根据流程实例id排序，需要结合order一起使用
	 */
	Boolean orderByProcessInstanceId = false;
	/**
	 * 根据任务执行人排序，需要结合order一起使用
	 */
	Boolean orderByTaskAssignee = false;
	/**
	 * 根据任务创建时间排序，需要结合order一起使用
	 */
	Boolean orderByTaskCreateTime = false;
	/**
	 * 根据任务描述排序，需要结合order一起使用
	 */
	Boolean orderByTaskDescription = false;
	/**
	 * 根据任务id排序，需要结合order一起使用
	 */
	Boolean orderByTaskId = false;
	/**
	 * 根据任务名称排序，需要结合order一起使用
	 */
	Boolean orderByTaskName = false;
	/**
	 * 根据任务优先级排序，需要结合order一起使用
	 */
	Boolean orderByTaskPriority = false;
	/**
	 * 根据租户id排序，需要结合order一起使用
	 */
	Boolean orderByTenantId = false;
	...
	public Boolean getOrderByDueDate() {
	...
	public Boolean getOrderByTaskCreateTime() {
		return orderByTaskCreateTime;
	}
	public void setOrderByTaskCreateTime(Boolean orderByTaskCreateTime) {
		this.orderByTaskCreateTime = orderByTaskCreateTime;
	}
	...
	public String toString() {
		return "WfTaskParam [name=" + name + ", nameLike=" + nameLike
				+ ", description=" + description + ", priority=" + priority
				+ ", minimumPriority=" + minimumPriority + ", maximumPriority="
				+ maximumPriority + ", assignee=" + assignee
				+ ", assigneeLike=" + assigneeLike + ", owner=" + owner
				+ ", ownerLike=" + ownerLike + ", unassigned=" + unassigned
				+ ", delegationState=" + delegationState + ", candidateUser="
				+ candidateUser + ", candidateGroup=" + candidateGroup
				+ ", involvedUser=" + involvedUser + ", taskDefinitionKey="
				+ taskDefinitionKey + ", taskDefinitionKeyLike="
				+ taskDefinitionKeyLike + ", processInstanceId="
				+ processInstanceId + ", processInstanceBusinessKey="
				+ processInstanceBusinessKey
				+ ", processInstanceBusinessKeyLike="
				+ processInstanceBusinessKeyLike + ", processDefinitionKey="
				...
				+ processDefinitionNameLike + ", executionId=" + executionId
				+ ", createdOn=" + createdOn + ", createdBefore="
				+ createdBefore + ", createdAfter=" + createdAfter + ", dueOn="
				+ dueOn + ", dueBefore=" + dueBefore + ", dueAfter=" + dueAfter
				+ ", withoutDueDate=" + withoutDueDate + ", excludeSubTasks="
				+ excludeSubTasks + ", active=" + active
				...
				+ ", withoutTenantId=" + withoutTenantId + ", orderByDueDate="
				+ orderByDueDate + ", orderByExecutionId=" + orderByExecutionId
				+ ", orderByProcessInstanceId=" + orderByProcessInstanceId
				+ ", orderByTaskAssignee=" + orderByTaskAssignee
				+ ", orderByTaskCreateTime=" + orderByTaskCreateTime
				+ ", orderByTaskDescription=" + orderByTaskDescription
				+ ", orderByTaskId=" + orderByTaskId + ", orderByTaskName="
				+ orderByTaskName + ", orderByTaskPriority="
				+ orderByTaskPriority + ", orderByTenantId=" + orderByTenantId
