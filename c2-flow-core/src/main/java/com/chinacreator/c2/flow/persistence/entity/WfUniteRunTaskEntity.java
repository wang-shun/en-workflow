...
public class WfUniteRunTaskEntity implements HasRevision, PersistentObject,
		Serializable {
	...
	public String getTaskTitle(Map<String, Object> parameters, String userCName, 
		...
		try {
			...
			if (wfUniteTaskResult != null) {
				...
				if (onlyTitle) {
					...
					taskTitle = "用户【" + userCName + "】的" + taskType1 + "任务："+this.name;
					if (titleColumns != null) {
						@SuppressWarnings("unchecked")
						Map<String, Object> mp = (Map<String, Object>) getPersistentState();
